...
// PowerTools setup
const logger = new Logger({ serviceName: 'sbt-data-sync' });
const tracer = new Tracer({ serviceName: 'sbt-data-sync' });
const metrics = new Metrics({ serviceName: 'sbt-data-sync', namespace: 'CloudBPA/SBT' });
